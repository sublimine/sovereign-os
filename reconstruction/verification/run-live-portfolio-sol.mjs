// Separate predeclared policy qualification: Sol/high versus the concurrent Astra/ultra mission.
// Same frozen request, oracle and runtime; outputs/plans/cache/timing can differ.
// No production default is changed and a single pair proves no general superiority.
...
const policy={model:'gpt-5.6-sol',reasoningEffort:'high',allowedTools:['workspace.list','workspace.read','workspace.write','execution.run'],instructionProfile:'scoped-v1',contextEncoding:'lossless-json-v2',reviewEncoding:'evidence-refs-v1'};
